  ...
  const videoTileContent = useMemo(() => {
    ...
    const disconnectedContent = (
      <div className="flex items-center justify-center text-gray-700 text-center w-full h-full">
        No AI mortgage agent video track. Connect to get started.
      </div>
    );
    ...
    const loadingContent = (
      <div className="flex flex-col items-center justify-center gap-2 text-gray-700 text-center h-full w-full">
        <LoadingSVG />
        Waiting for AI mortgage agent video track…
      </div>
    );
  ...
  const audioTileContent = useMemo(() => {
    const disconnectedContent = (
      <div className="flex flex-col items-center justify-center gap-2 text-gray-700 text-center w-full">
        No AI mortgage agent audio track. Connect to get started.
      </div>
    );
    ...
    const waitingContent = (
      <div className="flex flex-col items-center gap-2 text-gray-700 text-center w-full">
        <LoadingSVG />
        Waiting for AI mortgage agent audio track…
      </div>
    );
  ...
  const settingsTileContent = useMemo(() => {
    return (
      <div className="flex flex-col h-full w-full items-start overflow-y-auto">
        ...
        <ConfigurationPanelItem title="AI Mortgage Agent">
          <div className="flex flex-col gap-2">
            <EditableNameValueRow
              name="AI Agent name"
              value={
            ...
            <p className="text-xs text-gray-500 text-right">
              Set an AI mortgage agent name to use{" "}
              <a
