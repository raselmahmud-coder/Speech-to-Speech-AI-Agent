...
export function HomeInner() {
  ...
  // Auto-connect when environment variables are set
  useEffect(() => {
    if (process.env.NEXT_PUBLIC_LIVEKIT_URL && !shouldConnect) {
      console.log("AI Mortgage Coach: Auto-connecting with env variables...");
      connect("env");
    }
